...
all:
	...
	$(CXX) -I. -isystem $(PYBIND_INC) -isystem $(PYROOT)/include/python3.8 -O3 -DNDEBUG  -arch arm64 -isysroot $(SDK) -fPIC -fvisibility=hidden -Os -std=c++2a -MD -MT binder.cpp.o -MF binder.cpp.o.d -o binder.cpp.o -c binder.cpp
	$(CXX) -O3 -DNDEBUG -arch arm64 -isysroot $(SDK) -bundle -Wl,-headerpad_max_install_names -Xlinker -undefined -Xlinker dynamic_lookup -o A.cpython-38-darwin.so binder.cpp.o -L. -lA  $(PYROOT)/lib/libpython3.8.a
